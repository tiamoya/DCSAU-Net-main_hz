...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='data_bantu/', help='the path of image')
    parser.add_argument('--csvfile', type=str, default='src/test_train_data_bantu.csv',
    ...
    torch.save(model_ft, f'save_models/epoch_last_bantu.pth')
