...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='data1/', help='the path of image')
    parser.add_argument('--csvfile', type=str, default='src/test_train_data2.csv',
    ...
    weights_path = "save_models/epoch_last.pth"
    ...
    model_ft.load_state_dict(weights.state_dict())
    ...
    torch.save(model_ft, f'save_models/epoch_last2.pth')
