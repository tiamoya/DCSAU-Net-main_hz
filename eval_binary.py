...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='data_bantu/', type=str, help='the path of dataset')
    parser.add_argument('--csvfile', default='src/test_train_data_bantu.csv', type=str,
                        help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model', default='save_models/epoch_last_bantu.pth', type=str, help='the path of model')
    ...
    for image_id in test_files:
        img = cv2.imread(f'data_bantu/image/{image_id}')
